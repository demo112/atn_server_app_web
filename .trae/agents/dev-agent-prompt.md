...
1. 读取Task描述和设计文档
2. 读取相关已有代码，学习模式
3. **检查工程规范**：确认日志(Pino)、异常(AppError)、Lint规则
4. 编写代码，与设计保持一致
5. 自检：语法、类型、规范
...
2. **文档同步 (Mandatory)**：使用 `doc-sync` Skill
   > 说"同步文档"激活Skill
   > **必须检查**：需求文档(requirements)、设计文档(design)、任务清单(tasks) 是否与最终代码一致。
