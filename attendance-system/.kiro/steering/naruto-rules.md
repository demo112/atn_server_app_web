...
| 目录 | 说明 |
|------|------|
| packages/server/src/modules/attendance/ | 考勤模块 |
| packages/web/src/pages/attendance/ | 考勤页面 |
| packages/app/src/screens/clock/ | App 打卡 |
...
- packages/server/src/modules/employee/
- packages/server/src/modules/department/
- packages/server/src/modules/stats/
- packages/web/src/pages/user/
- packages/web/src/pages/employee/
- packages/web/src/pages/department/
- packages/web/src/pages/stats/
...
功能文档位置：docs/features/{SPEC_ID}/（如 SW62、SW63、SW64 等）
