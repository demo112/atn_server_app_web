...
| **Leave** | Duration | (未测试) | **超过余额**、**最小请假单位** (0.5h vs 0.1h) | 🔴 高 |
| **Leave** | DateRange | (已覆盖表单校验) | **开始时间 > 结束时间** (UI限制)、跨年 | 🟡 中 |
| **Leave** | Validation | (已覆盖) | 空表单提交、筛选参数传递 | 🟢 低 |
| **Leave** | StateGuard | (已覆盖) | 已撤销记录不可编辑 | 🟢 低 |
| **Shift** | Time | (未测试) | **次日时间** (如 25:00 或 次日01:00) | 🟡 中 |
...
| **Schedule** | 日期 | 过去时间、未来极限值 | 🟡 中 |
| **Stats** | 报表周期 | 1天, 31天, 365天 (性能边界) | 🟡 中 |
| **Correction** | 补卡次数 | 当月第1次 -> 第N次 (限制) | 🔴 高 |
...
|----------|------|----------|----------|------|
| Pending | 撤销 | Canceled | 允许 | ✅ (Correction已测) |
| Pending | 审批通过 | Approved | 写入考勤结果 | ✅ (Correction已测) |
| Pending | 审批拒绝 | Rejected | 释放余额 | ✅ (Correction已测) |
