...
| ID | 任务 | 端 | 故事点 | 验收标准 |
|----|------|:--:|:------:|----------|
| SW65-01 | 排班表 Prisma Model | Server | 1 | 人员-班次-有效期 |
| SW65-02 | 排班 Service | Server | 3 | 个人排班、批量排班、冲突检测 |
| SW65-03 | 排班 CRUD API | Server | 2 | 按人员/部门查询 |
| SW65-04 | 获取人员当日班次 API | Server | 2 | 打卡时调用 |
