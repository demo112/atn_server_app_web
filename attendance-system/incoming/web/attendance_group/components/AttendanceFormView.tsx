...
const AttendanceFormView: React.FC<AttendanceFormViewProps> = ({ group, onCancel, onSave }) => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto h-full flex flex-col">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col flex-1 overflow-hidden">
        ...
        {/* Footer Actions */}
        <div className="bg-gray-50 px-8 py-4 border-t border-gray-200 flex justify-center space-x-4">
          <button 
            onClick={onSave}
            className="px-10 py-2 bg-[#409eff] text-white rounded hover:bg-blue-600 transition text-sm font-medium shadow-sm"
          >
            确定
          </button>
          <button 
            onClick={onCancel}
            className="px-10 py-2 border border-gray-300 bg-white text-gray-600 rounded hover:bg-gray-50 transition text-sm font-medium"
          >
            取消
          </button>
        </div>
...
export default AttendanceFormView;
